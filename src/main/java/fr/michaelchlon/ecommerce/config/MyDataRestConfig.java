...
public class MyDataRestConfig implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(
        ...
        // INFO: disable HTTP methods for ProductCategory: PUT, POST, DELETE and PATCH
